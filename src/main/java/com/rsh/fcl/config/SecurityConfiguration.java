  ...
  SecurityFilterChain securityFilterChain(
    ...
    http
        ...
        .authorizeHttpRequests(auth -> auth
            ...
            .requestMatchers(HttpMethod.GET, "/api/cricketers/**").authenticated()
            .requestMatchers("/api/cricketers/**").hasRole("SUPERADMIN")
            .requestMatchers("/api/tournaments/**").hasRole("SUPERADMIN")
            .requestMatchers("/api/teams/**").hasRole("SUPERADMIN")
